...
# 684124197
#6525546927
#db_client.change_data(6525546927,'start_free_trial' , '26.03.2024')
#db_client.change_data(5221675666,'start_free_trial' , '26.03.2024')
...
with open('config.json') as file:
    ...
    end_data = date - timedelta(days=int(config['payment']["trial_period"]))
